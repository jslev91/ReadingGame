...
//
// ttsText: passed to speak() to produce the phoneme sound, not the letter name.
// Continuous consonants use repeated form (sss, fff) — TTS renders as a sound.
// Single letters and stop consonants use "as in [word]" — avoids TTS reading
// isolated characters as letter names ("ay", "tee", etc).

const phonics = [
  // ─── Phase 2 ───────────────────────────────────────────────────────────────
  // Set 1
  { grapheme: 's',  ttsText: 'sss',           phonemeDescription: 's as in sat',   exampleWords: ['sat', 'sun', 'sit'],   phase: 2, order: 1  },
  { grapheme: 'a',  ttsText: 'as in ant',      phonemeDescription: 'a as in ant',   exampleWords: ['cat', 'mat', 'tap'],   phase: 2, order: 2  },
  { grapheme: 't',  ttsText: 'as in tap',      phonemeDescription: 't as in tap',   exampleWords: ['tap', 'top', 'tin'],   phase: 2, order: 3  },
  { grapheme: 'p',  ttsText: 'as in pat',      phonemeDescription: 'p as in pin',   exampleWords: ['pat', 'pin', 'pot'],   phase: 2, order: 4  },
  // Set 2
  { grapheme: 'i',  ttsText: 'as in it',       phonemeDescription: 'i as in it',    exampleWords: ['sit', 'pin', 'big'],   phase: 2, order: 5  },
  ...
  { grapheme: 'd',  ttsText: 'as in dog',      phonemeDescription: 'd as in dog',   exampleWords: ['dog', 'dig', 'den'],   phase: 2, order: 8  },
  // Set 3
  { grapheme: 'g',  ttsText: 'as in got',      phonemeDescription: 'g as in get',   exampleWords: ['got', 'gap', 'gum'],   phase: 2, order: 9  },
  { grapheme: 'o',  ttsText: 'as in on',       phonemeDescription: 'o as in on',    exampleWords: ['dog', 'hot', 'top'],   phase: 2, order: 10 },
  { grapheme: 'c',  ttsText: 'as in cat',      phonemeDescription: 'c as in cat',   exampleWords: ['cat', 'cop', 'can'],   phase: 2, order: 11 },
  { grapheme: 'k',  ttsText: 'as in kit',      phonemeDescription: 'k as in kit',   exampleWords: ['kit', 'kin', 'kid'],   phase: 2, order: 12 },
  // Set 4
  { grapheme: 'ck', ttsText: 'as in duck',     phonemeDescription: 'ck as in duck', exampleWords: ['duck', 'sock', 'lock'], phase: 2, order: 13 },
  { grapheme: 'e',  ttsText: 'as in egg',      phonemeDescription: 'e as in egg',   exampleWords: ['bed', 'hen', 'net'],   phase: 2, order: 14 },
  { grapheme: 'u',  ttsText: 'as in up',       phonemeDescription: 'u as in up',    exampleWords: ['sun', 'cup', 'bus'],   phase: 2, order: 15 },
  ...
  { grapheme: 'b',  ttsText: 'as in bag',      phonemeDescription: 'b as in bag',   exampleWords: ['bag', 'bat', 'big'],    phase: 2, order: 18 },
  ...
  // ─── Phase 3 ───────────────────────────────────────────────────────────────
  // Set 6
  { grapheme: 'j',  ttsText: 'as in jet',      phonemeDescription: 'j as in jet',   exampleWords: ['jet', 'jab', 'job'],    phase: 3, order: 1 },
  { grapheme: 'v',  ttsText: 'vvv',            phonemeDescription: 'v as in van',   exampleWords: ['van', 'vet', 'vim'],    phase: 3, order: 2 },
  { grapheme: 'w',  ttsText: 'as in wet',      phonemeDescription: 'w as in wet',   exampleWords: ['wet', 'win', 'wig'],    phase: 3, order: 3 },
  { grapheme: 'x',  ttsText: 'as in fox',      phonemeDescription: 'x as in fox',   exampleWords: ['fox', 'box', 'wax'],    phase: 3, order: 4 },
  // Set 7
  { grapheme: 'y',  ttsText: 'as in yes',      phonemeDescription: 'y as in yes',   exampleWords: ['yes', 'yap', 'yet'],    phase: 3, order: 5 },
